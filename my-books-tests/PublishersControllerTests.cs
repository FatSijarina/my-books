...
namespace my_books_tests
{
    public class PublishersControllerTests
    {
        ...
        [Test, Order(3)]
        public void HTTPGET_GetPublisherById_ReturnsNotFount_Test()
        {
            int publisherId = 99;
            IActionResult actionResult = publishersController.GetPublisherById(publisherId);
        ...
        [Test, Order(6)]
        public void HTTPDELETE_DeletePulisherById_ReturnsOk_Test()
        {
            int publisherId = 6;
            IActionResult actionResult = publishersController.DeletePulisherById(publisherId);
            Assert.That(actionResult, Is.TypeOf<OkResult>());
        }

        [Test, Order(7)]
        public void HTTPDELETE_DeletePulisherById_ReturnsBadRequest_Test()
        {
            int publisherId = 6;
            IActionResult actionResult = publishersController.DeletePulisherById(publisherId);
            Assert.That(actionResult, Is.TypeOf<BadRequestObjectResult>());
